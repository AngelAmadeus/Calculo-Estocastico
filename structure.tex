...
\definecolor{ocre}{RGB}{127,118,121} % Define the orange color used for highlighting throughout the book
%--------------------------------------------------------------
%	FONTS
%--------------------------------------------------------------
...
\end{tikzpicture}};
\end{tikzpicture}
\fi\fi\par\vspace*{40\p@}}}%espacio despues de capitulo/seccion
%---------------------------------------------------------
